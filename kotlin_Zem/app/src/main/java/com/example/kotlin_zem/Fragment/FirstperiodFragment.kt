 ...
 * Use the [FirstperiodFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FirstperiodFragment: DialogFragment()  {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentFirstperiodBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFirstperiodBinding.inflate(inflater,container,false)
    ...
    companion object {
         ...
         * @return A new instance of fragment FirstperiodFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FirstperiodFragment().apply {
