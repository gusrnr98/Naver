...
import com.example.kotlin_naver.databinding.FragmentLogin1Binding
...
class loginFragment1 : Fragment() {
    ...
    interface  OnDataPassListener{
        fun onDataPass(id: String, pw: String)
    }
    ...
    override fun onCreateView(
        ...
        binding.loginBt.setOnClickListener {
            dataPassListener.onDataPass(binding.inputId.text.toString(),binding.inputPw.text.toString())
        }
        return binding.root
